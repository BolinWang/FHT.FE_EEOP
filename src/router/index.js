...
export const asyncRouterMap = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'initCustomerList', component: _import('userManage/initCustomerList'), name: '用户信息', hidden: true },
            { path: 'initOrgList', component: _import('userManage/initOrgList'), name: '组织列表', hidden: true }
        ]
    },
    {
        path: '/serviceManage',
