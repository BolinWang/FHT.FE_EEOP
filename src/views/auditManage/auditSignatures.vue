  ...
  <div class="app-container">
    <div class="model-search clearfix">
      <el-form size="small" :inline="true" :model="formData">
        ...
        <el-select size="small" style="width:120px" v-model="formData.status" placeholder="审核状态" class="filter-item item-select" clearable>
    ...
    <div class="dialog-info">
      <el-dialog :model="data_detail" :title="data_detail.type | typeFilter" :visible.sync="layer_showInfo" :width="data_detail.type | widthFilter" @close="dialogClose">
        <person-sign v-if="data_detail.type == 3" :data-sign="data_detail" ref="signOfRef">
        </person-sign>
        <compony-sign v-else-if="data_detail.type == 2" :data-sign="data_detail" ref="signOfRef">
        </compony-sign>
        <personto-compony-sign v-else :data-sign="data_detail" ref="signOfRef">
