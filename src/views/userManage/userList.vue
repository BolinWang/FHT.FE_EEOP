<template>
  <div class="app-container">
        ...
        <el-table-column label="操作" width="220">
          <template slot-scope="scope">
            <el-button-group>
              ...
              <el-button type="danger" icon="el-icon-delete" size="small" v-if="scope.row.isAdmin != 1" @click.native="deleteUser(scope.$index,scope.row)">删除</el-button>
            </el-button-group>
          </template>
        </el-table-column>
      </el-table>
    ...
    <div class="dialog-info">
      <el-dialog title="新增账号" :visible.sync="layer_showInfo" width="600px" @close="dialogClose">
