<template>
  <div class="clearfix">
    <div class="model-table" :style="tableStyle" style="margin-top: 0;">
      <el-table :data="tableData" v-loading.body="listLoading" :max-height="tableHeight" size="small" @selection-change="handleSelectionChange" fit stripe highlight-current-row>
