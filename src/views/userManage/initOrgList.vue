<template>
  <div class="app-container">
    <div class="model-search clearfix">
      <el-select size="small" v-model="formData.organizationType" placeholder="联系状态" class="item-select" style="width: 150px;" @change="searchParam">
        <el-option v-for="item in selectOptions" :key="item.value" :label="item.label" :value="item.value">
        </el-option>
      </el-select>
      <el-input size="small" v-model.trim="formData.searchField" placeholder="组织名称/缩写名" class="filter-item" style="width:180px;" @keydown.native.enter="searchParam">
      </el-input>
      <el-button type="primary" size="small" icon="el-icon-search" @click.native="searchParam" v-waves class="filter-item">
        查询
      </el-button>
    ...
    <div class="model-table" :style="tableStyle">
      <el-table :data="tableData" v-loading.body="listLoading" :max-height="tableHeight" @selection-change="handleSelectionChange" size="small" fit stripe highlight-current-row>
    ...
    <div class="dialog-info">
      <el-dialog :title="overlayTitle" :visible.sync="layer_showInfo" width="800px" @close="dialogClose">
        ...
        <el-form size="small" status-icon v-show="active == 0 ? true : false" :model="stepForm1" :rules="rules" ref="stepForm1" label-width="110px">
          <div class="clearfix" style="margin-top: 10px">
            <el-col :span="12">
              <el-form-item label="企业名称" prop="organizationName">
                <el-input v-model.trim="stepForm1.organizationName" :disabled="isEdit"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <div class="clearfix">
            <el-col :span="24">
              <el-form-item label="统一社会信用码" prop="orgLicence" label-width="140px">
                <el-input v-model.trim="stepForm1.orgLicence" :disabled="isEdit"></el-input>
              </el-form-item>
            </el-col>
          </div>
          <div class="clearfix">
          ...
          <div class="clearfix">
            <el-col :span="12">
              <el-form-item label="法人姓名" prop="orgLegalPersonName">
                <el-input v-model="stepForm1.orgLegalPersonName" :disabled="isEdit"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="法人身份证号" prop="orgLegalPersonCardNo">
                <el-input v-model="stepForm1.orgLegalPersonCardNo" :disabled="isEdit"></el-input>
              </el-form-item>
            </el-col>
          </div>
          <div class="clearfix">
          ...
          <el-switch v-model="financeTrusteeshipType" active-text="磐谷金融托底方" active-value="2" inactive-value="1" :disabled="financeEdit" @change="changefinanceType" v-if="isEdit">
          </el-switch>
        </el-form>
        <div class="clearfix" v-show="active == 1 ? true : false">
          <div v-for="(item,index) in permTemplate" :key="index">
            <el-row class="mtop">
              <el-radio v-model="organizationPermTemplateId" :label="item.organizationPermTemplateId">
                {{item.name}}
              </el-radio>
            </el-row>
        ...
        <el-form size="small" v-show="active == 2 ? true : false" :rules="rules" :model="stepForm2" ref="stepForm2" label-width="110px">
          <div class="clearfix" style="margin-top: 10px">
            <el-col :span="9">
            ...
            <el-col :span="6">
              <el-form-item label="性别" label-width="50px">
                <el-select size="small" v-model="stepForm2.gender" :disabled="isEdit" placeholder="性别" class="item-select">
          ...
          <div class="clearfix">
            <el-col :span="12">
              <el-form-item label="证件类型">
                <el-select size="small" v-model="stepForm2.cardType" :disabled="isEdit" placeholder="证件类型" class="item-select">
    ...
    <div class="dialog-image">
      <el-dialog title="" width="100%" :show-close="false" :visible.sync="layer_showImage" style="text-align: center;" @click.native="closeDialog" @close="showPicUrlClose">
