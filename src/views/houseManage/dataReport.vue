    ...
    <el-container>
      <el-aside width="240px">
        <div class="model-search">
          ...
          <el-date-picker :clearable="clearable" v-model="dateTime" size="small" style="margin-bottom: 10px;width: 100%;" type="daterange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期">
          </el-date-picker>
          <el-input type="textarea" :style="textareaHeight" style="margin-bottom: 10px;" placeholder="请输入手机号码或组织名称，多个请换行查询" v-model="textareaVal">
          </el-input>
        </div>
      </el-aside>
